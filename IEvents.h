...
enum { NOHAYMOVIMIENTO = 50, UPDERECHA, DOWNDERECHA, UPABAJODERECHA, DOWNABAJODERECHA, UPABAJO, DOWNABAJO, UPABAJOIZQUIERDA, DOWNABAJOIZQUIERDA,
        UPIZQUIERDA, DOWNIZQUIERDA, UPARRIBAIZQUIERDA, DOWNARRIBAIZQUIERDA, UPARRIBA, DOWNARRIBA, UPARRIBADERECHA, DOWNARRIBADERECHA, UPBOTON, DOWNBOTON, DOWNESCAPE, UPESCAPE, };

/*Constantes que servirian para en un futuro guardar en el buffer las letras y los numeros*/
enum { DOWNA=101, UPA, DOWNB, UPB, DOWNC, UPC, DOWND, UPD, DOWNE, UPE, DOWNF, UPF, DOWNG, UPG, DOWNH, UPH, DOWNI, UPI, DOWNJ, UPJ, DOWNK, UPK, DOWNL, UPL, DOWNM, UPM, DOWNN, UPN,
